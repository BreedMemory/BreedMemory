...
public class AddBabyHealthData extends BabyHealthData {
     ...
     */
    public AddBabyHealthData(int childId, String statTime, String statValue03, String statValue01, String statValue35, String statValue36, String statValue37, int fileFlag) {
